...
public class MedicamentRepositoryTest {
    ...
    void findByIdWithExistingIdShouldReturnCorrectCake() throws InvalidCNPException, NonUniqueCNPException, PozitivePriceException {
    ...
    @org.junit.jupiter.api.Test
    void upsertShouldInsertAndUpdateMed() throws InvalidCNPException, NonUniqueCNPException, PozitivePriceException {
...
/*
    ...
    @org.junit.jupiter.api.Test
    void getAllShouldReturnAllMeds() throws InvalidCNPException, NonUniqueCNPException, PozitivePriceException {
        IValidator<Medicament> medicamentValidator = (IValidator<Medicament>) new MedicamentValidator();
        IRepository<Medicament> repo = new InMemoryRepository<>(medicamentValidator);
        Medicament med1 = new Medicament("1", "test", "test", 100,true);
        Medicament med2 = new Medicament("2", "test", "test", 100,true);
